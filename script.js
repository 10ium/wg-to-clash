...
const AMNEZIA_PROFILES = [
    { id: 'سفارشی', name: 'سفارشی (مقادیر دستی)', isCustom: true, checked: false },
    { id: 'متعادل_روزانه', name: 'مدل متعادل روزانه', jc: 4,  jmin: 64,  jmax: 120,  checked: false },
    { id: 'شبکه_ضعیف', name: 'مناسب شبکه ضعیف', jc: 6,  jmin: 64,  jmax: 80,   checked: true },
    { id: 'تهاجمی_ضد_بازرسی', name: 'الگوی تهاجمی ضد بازرسی عمیق', jc: 8,  jmin: 64,  jmax: 150,  checked: true },
    { id: 'سریع_کم_تاخیر', name: 'سریع با سربار کم', jc: 2,  jmin: 64,  jmax: 70,   checked: false },
    { id: 'سازگار_پروتون', name: 'سازگار با پروتون (حداقل تغییر پروتکل)', jc: 4,  jmin: 40,  jmax: 70,   checked: false },
    { id: 'متعادل_قدیمی', name: 'مدل متعادل قدیمی', jc: 5,  jmin: 50,  jmax: 100,  checked: false },
    { id: 'سازگار_گسترده', name: 'سازگاری گسترده با بازه بزرگ', jc: 4,  jmin: 40,  jmax: 250,  checked: false },
    { id: 'ریز_نویز', name: 'ریز نویز کم تاخیر', jc: 3,  jmin: 10,  jmax: 30,   checked: false },
    { id: 'سیلاب_سنگین', name: 'سیلاب سنگین برای لیست سفید', jc: 10, jmin: 30,  jmax: 60,   checked: true },
    { id: 'استراتژی_پنهانکاری_حداکثری', name: 'استراتژی پنهانکاری حداکثری', jc: 31, jmin: 20,  jmax: 40,   checked: true },
    { id: 'پوشش_آنتروپی_بالا', name: 'پوشش آنتروپی بالا ضد کاهش سرعت', jc: 33, jmin: 132, jmax: 1200, checked: true },
    { id: 'شبیه_سازی_ترافیک_سنگین', name: 'شبیه سازی ترافیک سنگین برای لیست سفید', jc: 50, jmin: 5,   jmax: 1500, checked: false },
    { id: 'بازه_ثابت_پانصد', name: 'بازه ثابت حدود پانصد بایت', jc: 5,  jmin: 500, jmax: 501,  checked: false },
    { id: 'پیشفرض_رسمی', name: 'پیشفرض رسمی متعادل', jc: 8,  jmin: 50,  jmax: 1000, checked: false },
    { id: 'گیمینگ_فوق_کم_تاخیر', name: 'گیمینگ با تاخیر بسیار پایین', jc: 3,  jmin: 64,  jmax: 80,   checked: false }
];
